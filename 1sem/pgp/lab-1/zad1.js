...
function initBuffers() {
  ...
  var arrowVertices = [
    // Прямоугольник хвоста стрелки
    -0.3, 0.2, 0.0,  // левый верхний угол
    0.1, 0.2, 0.0,  // правый верхний угол
    -0.3, -0.2, 0.0, // левый нижний угол
    
    -0.3, -0.2, 0.0, // левый нижний угол
    0.1, 0.2, 0.0,  // правый верхний угол
    0.1, -0.2, 0.0, // правый нижний угол

    // Головка стрелки
    0.1, 0.4, 0.0,  // верхний конец стрелки
    0.5, 0.0, 0.0,   // вершина стрелки
    0.1, -0.4, 0.0, // нижний конец стрелки

    // Вырез в основании стрелки
    0.1, 0.4, 0.0,  // правый верхний угол хвоста
    0.5, 0.0, 0.0,   // внутренняя вершина
    0.1, -0.4, 0.0, // правый нижний угол хвоста
  ]
  
  gl.bufferData(
    gl.ARRAY_BUFFER,
    new Float32Array(arrowVertices),
    gl.STATIC_DRAW
  );

  // указываем кол-во точек
  vertexBuffer.itemSize = 3;
  vertexBuffer.numberOfItems = arrowVertices.length / 3; // Обновляем количество элементов
}
